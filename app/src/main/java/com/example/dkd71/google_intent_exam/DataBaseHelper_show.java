...
public class DataBaseHelper_show extends SQLiteOpenHelper
{
    ...
    private static String DB_NAME ="dateset_file.db";

    private SQLiteDatabase mDataBase2;
    private final Context mContext2;

    public DataBaseHelper_show(Context context)
    {
    ...
    {
        InputStream mInput = mContext2.getAssets().open(DB_NAME);
    ...
    public boolean openDataBase() throws SQLException
    {
        ...
        //Log.v("mPath", mPath);
        mDataBase2 = SQLiteDatabase.openDatabase(mPath, null, SQLiteDatabase.CREATE_IF_NECESSARY);
        //mDataBase = SQLiteDatabase.openDatabase(mPath, null, SQLiteDatabase.NO_LOCALIZED_COLLATORS);
        return mDataBase2 != null;
    }
